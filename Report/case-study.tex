...
The dataset used in this project was introduced by Cortez et al. [citation]
...
\subsection{KNN}
K-Nearest Neighbors (KNN) is a supervised learning algorithm that can be utilized for both classification and regression tasks. The fundamental principle of KNN is to classify a data point based on the class labels of its K-nearest neighbors in the feature space. The choice of K, as well as the metric used for calculating distance, are important factors that influence the performance of the model.
...
The prediction correctness is shown in figure below:\\
	...
	\label{fig:foo}
	\begin{center}
	\includegraphics[scale=0.3]{RandomForestBar.jpeg}
...
\bibitem{b1} Wine Quality Data Set, https://archive.ics.uci.edu/ml/datasets/wine+quality
\bibitem{b2} P. Cortez, A. Cerdeira, F. Almeida, T. Matos, and J. Reis, "Modeling wine preferences by data mining from physicochemical properties," in IEEE Transactions on Neural Networks, vol. 17, no. 5, pp. 1136-1140, Sept. 2006. doi: 10.1109/TNN.2006.176
